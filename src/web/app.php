...
<div id='content-wrapper'>
    ...
    <div id='settings' class='page no-display'>
        ...
        <div class='page-button-wrapper'>
            ...
            <div class='page-button red fadeColor' id='settings-delete' onClick="javascript:deleteListAction();">Delete</div>
        </div>
    </div>
    ...
    <div id='notfound' class='page no-display'>
        <h1 class='page-header'>Not Found</h1>
        <p>The list you're trying to access does not exist or you no longer have access to it.</p>
    </div>
</div>
